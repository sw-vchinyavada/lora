...
.PHONY: install train run mfi-api mfi-front clean clean-start docker-train docker-up test help
...
clean:
	...
	@rm -f models/baseline/*.pkl models/lora/*.pt models/lora/*.bin models/preprocessor.pkl models/dataset_name.txt models/score_calibration.json 2>/dev/null || true
